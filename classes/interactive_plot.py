...
class interactive_plot:
    ...
    def plot_with_data(self, sampledTimeStamps, sampledpupilData, sampledgazexData, sampledgazeyData, lumData, contrastData, y_pred, lumConv, contrastConv):
        ...
        # axes[3].set_ylim([-4,4])
        # set_ylim according to std instead of hard code
        axes[3].set_ylim([min(min(lumData),min(contrastData)),max(max(lumData),max(contrastData))])
